...
const Guide: FC = () => {
  ...
  const px = md ? (lg ? "120px" : "60px") : "20px";

  return (
    <Box>
      <Box pt={12} id="guide" bgcolor="#0461B5">
        <Typography
          sx={{
            mb: "56px",
            textAlign: "center",
        ...
        <Stack px={px} spacing={sm ? "36px" : "28px"}>
          ...
          <GuideStep step={3} title="Регистрация и получение стартового пакета">
            ...
            <Stack component="ul" spacing="6px" sx={{ m: 0, pl: "20px" }}>
              {[
                ...
                <Typography key={item} component="li" sx={bodyText(md, sm)}>
                  {item}
                </Typography>
              ))}
            </Stack>
